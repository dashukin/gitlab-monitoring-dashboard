...
import { getCurrentProjectMergeRequests } from 'src/client/selectors/composed/project/project.selector';
import { getCurrentProjectIsLoading } from 'src/client/selectors/composed/project/project.selector';
import Project from './project.component';

const mapStateToProps = state => ({
  projectId: getProjectId(state),
  project: getCurrentProject(state),
  mergeRequests: getCurrentProjectMergeRequests(state),
